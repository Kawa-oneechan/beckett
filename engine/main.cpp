...
extern void GameStart(std::vector<Beckett::TickableP>& tickables);
...
extern void SettingsLoad(Beckett::jsonObject& settings);
extern void SettingsSave(Beckett::jsonObject& settings);
