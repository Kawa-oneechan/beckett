...
namespace Beck
{
	...
	void DropLabel::update()
	{
		...
		Beck::Texture tempTexture(tempTID, sizeX, sizeY, 4);
		...
		Beck::Texture blurTexture(blurTID, sizeX / blurSizeDiv, sizeY / blurSizeDiv, 4);
		...
		glViewport(0, 0, Beck::width, Beck::height);
